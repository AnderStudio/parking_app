...
import MapPageA from "./Component/MapPageA/MapPageA";
import MapPageB from "./Component/MapPageB/MapPageB";
import MapPageC from "./Component/MapPageC/MapPageC";
import MapPageD from "./Component/MapPageD/MapPageD";
    ...
    <div className="App">
      <header className="App-header d-flex flex-column justify-content-between">
        <Routes>
          ...
          <Route path="/FindCarA" element={<FindCarPageA />}>
            {" "}
          </Route>
          <Route path="/FindCarB" element={<FindCarPageB />}>
            {" "}
          </Route>
          <Route path="/FindCarC" element={<FindCarPageC />}>
            {" "}
          </Route>
          <Route path="/FindCarD" element={<FindCarPageD />}>
            {" "}
          </Route>
          <Route path="/ReserveBook" element={<ReserveBookPage />}>
            {" "}
          </Route>
          <Route path="/MapPageA" element={<MapPageA />}>
            {" "}
          </Route>
          <Route path="/MapPageB" element={<MapPageB />}>
            {" "}
          </Route>
