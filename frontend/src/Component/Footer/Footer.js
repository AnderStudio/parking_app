...
function Footer() {
  return (
    <nav className="nav">
      <div className= "py-1 text-bg-dark footer footer_color">
            ...
            <ul className="nav col-12 col-lg-auto my-2 d-flex flex-row justify-content-around my-md-0 text-small nav-list w-100">
              <li>
                <NavLink exact="true" to='/' className="text-white">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-p-circle" viewBox="0 0 16 16">
              ...
              <li>
                <NavLink to='/FindCar' className="text-white">
              ...
              <li>
                <NavLink to='/Reserve' className="text-white">
