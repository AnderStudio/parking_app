...
function Footer2() {
  return (
    <nav className="nav">
      <div className="w-auto mt-auto px-3 py-2 text-bg-dark footer">
        <div className="container">
          <div className="d-flex align-items-center justify-content-around">
            <ul className="nav col-12 col-lg-auto my-2 d-flex flex-row justify-content-around my-md-0 text-small nav-list w-100">
              ...
              <li>
                <NavLink to='/CarReserve' className="text-white">
              ...
              <li>
                <NavLink to='/CarEntry' className="text-white">
              ...
              <li>
                <NavLink to='/BlackList' className="text-white">
