        ...
        <div>
          ...
          <div className="input-group mb-3 d-flex flex-column">
            <div className="d-flex flex-row justify-content-center">
              <input type="text" id="message" name="message" className="form-control w-50" placeholder="License plate number" aria-label="Recipient's username" aria-describedby="button-addon2" onChange={handleChange}/>
